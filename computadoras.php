  ...
  <header>
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Computadoras y laptops</li>
      </ol>
    </nav>
  </header>
  ...
  <div class="container my-5 p-5 ">
    <div class="py-5">
      <div class="row">
        ...
        $cnx = DBCnx();
        $data = $cnx->query("SELECT`titulo`, `contenido`, `link`, `etiqueta`, `ruta` FROM `card` WHERE etiqueta = 'Computadoras y laptops'")->fetchAll();
        foreach ($data as $row) {
        ?>
